...
if ( ! class_exists( 'SinglePress_WP_Bootstrap_Navwalker' ) ) {
	/**
	 * SinglePress_WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class SinglePress_WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( 0 === strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
				...
				if ( isset( $args->link_before ) && isset( $item->title )  && isset( $item->ID ) && isset ( $args->link_after)) {					
